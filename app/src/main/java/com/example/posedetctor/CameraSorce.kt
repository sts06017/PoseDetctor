...
import com.example.posedetctor.PreferenceUtils.getCameraPreviewSizePair
...
class CameraSource(protected var activity: Activity, private val graphicOverlay: GraphicOverlay) {
  ...
  private var facing: Int = CAMERA_FACING_BACK
  /**
  ...
  private fun createCamera(): Camera {
    ...
    var sizePair = getCameraPreviewSizePair(
      activity, requestedCameraId
    )
    if (sizePair == null) {
